...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2018 at 07:54 AM
...
CREATE TABLE `booking` (
  ...
  `destinationplace` varchar(35) NOT NULL,
  `quantity` int(11) NOT NULL,
  `total` int(10) NOT NULL,
  `date` date NOT NULL,
  `owner_regid` int(20) NOT NULL
...
--
-- Table structure for table `crusherreg`
--

CREATE TABLE `crusherreg` (
  `crusherid` int(11) NOT NULL,
  `regid` int(11) NOT NULL,
  `crushername` varchar(25) NOT NULL,
  `licenceno` varchar(25) NOT NULL,
  `crusherplace` varchar(35) NOT NULL,
  `description` varchar(500) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `crusherreg`
--

INSERT INTO `crusherreg` (`crusherid`, `regid`, `crushername`, `licenceno`, `crusherplace`, `description`, `status`) VALUES
(1, 2, 'St.Jude', 'A123', 'Pala', 'Available', 1);
...
INSERT INTO `job` (`applyid`, `jobid`, `regid`, `qualification`, `image`, `image1`, `status`, `crusherid`) VALUES
(1, 1, 1, 'No Qualifications - Experienced', 'photo/1522729238RESUME.pdf', 'photo/1522729238RESUME.pdf', 1, 1);
...
INSERT INTO `jobdetails` (`id`, `regid`, `jobname`, `jobtype`, `vaccancies`, `salary`, `qualification`) VALUES
(1, 2, '1', '1', 2, 15000, 'licence');
...
INSERT INTO `jobss` (`jobssid`, `jobid`, `jobtype`) VALUES
(1, 1, 'Permanent');

-- --------------------------------------------------------

--
-- Table structure for table `jobvaccancies`
--

CREATE TABLE `jobvaccancies` (
  `jobid` int(10) NOT NULL,
  `jobname` varchar(30) NOT NULL,
  `jobtype` varchar(30) NOT NULL,
  `vaccancies` int(10) NOT NULL,
...
CREATE TABLE `login` (
  `userid` int(11) NOT NULL,
  `regid` int(11) NOT NULL,
  `username` varchar(35) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
...
INSERT INTO `login` (`userid`, `regid`, `username`, `Password`, `Role`, `status`) VALUES
(1, 1, 'admin', 'admin', 'admin', 1),
(2, 1, 'joselin', 'joselin', 'customer', 1),
(3, 2, 'joice', 'joice', 'owner', 1);
...
INSERT INTO `owner` (`Login_id`, `email`) VALUES
(3, 'joicemathew1991@gmail.com');
...
INSERT INTO `productdetails` (`id`, `category`, `subcategory`, `rate`, `regid`) VALUES
(1, 1, '1', 30, 2),
(2, 2, '3', 40, 0),
(3, 2, '3', 40, 2);
...
CREATE TABLE `register` (
  ...
  `status` int(20) NOT NULL DEFAULT '2',
...
INSERT INTO `register` (`regid`, `role`, `username`, `firstname`, `lastname`, `housename`, `place`, `district`, `state`, `pincode`, `contactno`, `email`, `aadharno`, `status`, `plan`) VALUES
(1, 'customer', 'joselin', 'Joselin', 'Mathew', 'Vattamalyil', 'Marangattupilly', 'Kottayam', '18', 686635, '9847982641', 'joselinmathew1995@gmail.com', '036902580147456', 1, 'upload/693a7.jpg'),
(2, 'owner', 'joice', 'Joice', 'Mathew', 'Olickal', 'Pala', 'Kottayam', '18', 686632, '9847651036', 'joicemathew1991@gmail.com', '036902580147789', 1, 'upload/2665a4.jpg');
...
INSERT INTO `subcategory` (`subid`, `catid`, `subname`) VALUES
(1, 1, '3/4'),
(2, 1, '1/4'),
(3, 2, 'Washed Sand');
...
--
-- Indexes for table `crusherreg`
--
ALTER TABLE `crusherreg`
  ADD PRIMARY KEY (`crusherid`);
...
--
-- Indexes for table `jobss`
--
ALTER TABLE `jobss`
  ADD PRIMARY KEY (`jobssid`);

--
-- Indexes for table `jobvaccancies`
--
ALTER TABLE `jobvaccancies`
  ADD PRIMARY KEY (`jobid`);
...
--
-- AUTO_INCREMENT for table `crusherreg`
--
ALTER TABLE `crusherreg`
  MODIFY `crusherid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `jobss`
--
ALTER TABLE `jobss`
  MODIFY `jobssid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `jobvaccancies`
--
ALTER TABLE `jobvaccancies`
...
--
ALTER TABLE `subcategory`
  MODIFY `subid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
